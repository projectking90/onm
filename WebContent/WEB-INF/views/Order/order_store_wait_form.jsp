...
<!-- CSS파일 수입 -->
<%@ include file="/WEB-INF/resources/Order/order_store_wait_css.jsp" %>
<!-- JQuery 라이브러리 파일 수입 -->
<%@ include file="/WEB-INF/resources/Order/order_store_wait_js.jsp" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>주문확인 - 접수대기(가게) 페이지</title>
		<!-- 가게가 주문 확인 기능 선택 시 보여줄 페이지 -->
