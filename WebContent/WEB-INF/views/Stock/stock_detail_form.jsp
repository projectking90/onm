...
<html>
	<head>
		...
		<!-- CSS파일 수입 -->
		<link href="${cr}/resources/Stock/stock_detail_form.css" rel="stylesheet" type="text/css">
		<!-- JQuery 라이브러리 파일 수입 -->
		<script src="${cr}/resources/Stock/stock_detail_form.js" type="text/javascript"></script>
